...
public class AgregarUsuario {
    ...
    private void applyTheme() {
        ...
        if (panelMain != null) panelMain.setBorder(new EmptyBorder(14, 14, 14, 14));
        ...
        // Tipografías base en inputs
        if (txtNombre != null)      txtNombre.setFont(fText);
        if (txtContrasena != null)  txtContrasena.setFont(fText);
        if (cmbTrabajador != null)  cmbTrabajador.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        if (cmbActivo != null)      cmbActivo.setFont(new Font("Segoe UI", Font.PLAIN, 14));

        // Inputs con borde redondeado + focus
        if (txtNombre != null)     styleTextField(txtNombre);
